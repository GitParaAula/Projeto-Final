...
namespace ProjetoFinal.Controllers
{
    ...
    private readonly CadastroFuncRepositorio _CadastroFuncRepositorio;
        public CadastroFuncController(CadastroFuncRepositorio CadastroFuncRepositorio)
        {
        ...
        [HttpGet]
        public IActionResult CadastroFunc()
        {
            return View();
        }
        [HttpPost]
        public IActionResult CadastroFunc(Funcionario funcionario)
        {
            ...
            if (!nomeValido || !cpfValidoNumerico || !rgValidoNumerico)
            {
                ...
                return View("CadastroFunc", funcionario);
            }
